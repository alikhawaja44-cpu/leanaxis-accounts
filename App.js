                    ...
                    <form onSubmit={handleAddSubmit} className="space-y-5">
                        ...
                        {view === 'salaries' && (
                          <>
                            ...
                            <input placeholder="Employee Name" className="w-full border border-slate-200 p-3 rounded-xl text-sm" value={formData.employeeName || ''} onChange={e => setFormData({ ...formData, employeeName: e.target.value })} />
                            <input type="number" placeholder="Total Payable Amount" className="w-full border border-slate-200 p-3 rounded-xl text-sm" value={formData.totalPayable || ''} onChange={e => setFormData({ ...formData, totalPayable: e.target.value })} />
                            <select className="w-full border border-slate-200 p-3 rounded-xl text-sm bg-white" value={formData.status || 'Unpaid'} onChange={e => setFormData({ ...formData, status: e.target.value })}>
